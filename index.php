  ...
  <div class="max-w-5xl mx-auto w-full flex flex-col bg-white shadow-lg rounded-lg border border-gray-200 overflow-hidden my-8">
    ...
    <section class="flex flex-col sm:flex-row justify-between items-center gap-4 px-6 py-4 border-b border-gray-200">
      ...
      <div class="text-gray-600 font-medium text-sm whitespace-nowrap flex items-center space-x-2">
        ...
        <input type="month" id="periodeInput" class="border border-gray-300 rounded-md bg-white text-gray-900 text-sm font-mono px-3 py-1.5 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition" value="2025-09" aria-label="Periode">
      </div>
    </section>
    ...
    <!-- + Update Tahapan -->
    <button id="toggleUpdateForm" class="w-full text-indigo-600 font-semibold text-left px-6 py-2 hover:bg-indigo-50 transition flex items-center space-x-2 border-b border-gray-200 font-mono" aria-expanded="false" aria-controls="updateForm">
    ...
    <section id="updateForm" class="px-6 py-4 text-xs text-gray-700 font-mono hidden">
      ...
      <form onsubmit="return false;" class="space-y-2">
        <div>
          ...
          <input type="text" id="inputTahapan" readonly value="Pembuatan SPP & SPM Gaji" class="w-full border border-black px-1 py-0.5 bg-gray-100">
        </div>
        <div>
          <label for="inputStatus" class="block mb-0.5">Status</label>
          <input type="text" id="inputStatus" readonly value="[ Pending  Proses  Selesai ]" class="w-full border border-black px-1 py-0.5 bg-gray-100">
        </div>
        <div>
          <label for="inputTanggal" class="block mb-0.5">Tanggal</label>
          <input type="text" id="inputTanggal" readonly value="30082025" class="w-full border border-black px-1 py-0.5 bg-gray-100">
        </div>
        <div>
          <label for="inputCatatan" class="block mb-0.5">Catatan</label>
          <textarea id="inputCatatan" readonly rows="2" class="w-full border border-black px-1 py-0.5 bg-gray-100 resize-none">[Input di aplikasi SIMDA]</textarea>
        </div>
        <div>
          <label for="inputDokumen" class="block mb-0.5">Dokumen</label>
          <input type="text" id="inputDokumen" readonly value="[ Link GDrive ]" class="w-full border border-black px-1 py-0.5 bg-gray-100">
        </div>
        <div class="flex space-x-2">
          <button type="button" class="border border-black px-3 py-1 font-semibold hover:bg-gray-200 transition">Simpan Draft</button>
          <button type="button" class="border border-black px-3 py-1 font-semibold hover:bg-gray-200 transition">Kirim ke Pimpinan</button>
        </div>
      </form>
    </section>
  </div>
